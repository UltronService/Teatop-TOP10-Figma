/**
 * TEA TOP 第一味 - TOP 10 人氣飲品排行榜 (Index 2)
 * 連動 teatop2 視覺動態特效 (Active Invert & Highlight Animations)
 */
...
class MenuBoardApp2 {
  ...
  selectDrink(index, animate = true) {
    ...
    if (animate) {
      ...
      this.heroImg.style.transform = 'scale(0.88) translateY(15px)';
